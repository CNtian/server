...
func (this *GameKWXTable) handleXiaoJieSuan() {
	...
	if this.gameRule.IsShangLou && this.playPaiLogic.shangLouDianShu[0] == this.playPaiLogic.shangLouDianShu[1] {
		roundOver.IsShangLou = true
	}
...
func (this *GameKWXTable) onGetTableData(pro *mateProto.MessageMaTe) int32 {
	...
	tableData := SC_TableData{
		...
		ShaiZi:              this.playPaiLogic.shangLouDianShu,
	}
