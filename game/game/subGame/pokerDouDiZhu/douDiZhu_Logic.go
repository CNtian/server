...
type PokerDouDizhuLogic struct {
	rule *PokerDouDiZhuRule
...
func (A *PokerDouDizhuLogic) IsGreaterX(B *PokerDouDizhuLogic) int32 {
...
func (this *PokerDouDizhuLogic) ParsePaiXing(shouPaiCount int32, playPai []int8, assignPaiXing int32) bool {
	this.Pai = playPai
...
func (this *PokerDouDizhuLogic) CleanStatus() {
	this.Pai = nil
...
func (this *PokerDouDizhuLogic) GetPaiXing() int32 {
	return this.PaiXing
}

func (this *PokerDouDizhuLogic) SetRule(value interface{}) {
	this.rule = value.(*PokerDouDiZhuRule)
}

func (this *PokerDouDizhuLogic) Is_ZhaDan() bool {
...
func (this *PokerDouDizhuLogic) Is_SiDaiEr() bool {
...
func (this *PokerDouDizhuLogic) Is_SiDaiSang() bool {
...
func (this *PokerDouDizhuLogic) Is_FeiJi() bool {
	this.SequenceCount = 0
...
func (this *PokerDouDizhuLogic) Is_SanDai_Er() bool {
...
func (this *PokerDouDizhuLogic) Is_SanDai_Yi() bool {
...
func (this *PokerDouDizhuLogic) Is_Lian_Dui() bool {
	this.SequenceCount = 0
	if len(this.Pai) < 4 ||
		(len(this.Pai)%2) != 0 {
		return false
...
func (this *PokerDouDizhuLogic) Is_Yi_Dui() bool {
	if len(this.Pai) == 2 {
...
func (this *PokerDouDizhuLogic) Is_Shun_Zi() bool {
	if len(this.Pai) < 5 {
		return false
	}
...
func (this *PokerDouDizhuLogic) ParseYiShouChu(shouPaiCount int32, playPai []int8) bool {
