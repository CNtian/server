...
type PokerPDKSeat struct {
	seatData       *qpTable.SeatData
	paiLogic       paoDeKuaiLogic
	bombCount      int32
	winCount       int32
	loseCount      int32
	chunTianCount  int32
...
// 清理座位一轮数据
func (this *PokerPDKSeat) CleanRoundData() {
...
func (this *PokerPDKSeat) GetSeatData() *qpTable.SeatData {
	return this.seatData
}

func (this *PokerPDKSeat) GetXSeatData(int) interface{} {
	return this
}

func (this *PokerPDKSeat) SetOperationItem(value OperationItem) {
...
// 添加手牌
func (this *PokerPDKSeat) PushShouPai(pai int8) {
...
// 删除手牌
func (this *PokerPDKSeat) DeleteShouPai(pai int8) bool {
	count, ok := this.shouPai[pai]
	if ok == true && count > 0 {
		this.shouPai[pai] = count - 1
		this.shouPaiCount -= 1
...
// 牌 是否存在
func (this *PokerPDKSeat) GetPaiCount(pai int8) int {
...
func (this *PokerPDKSeat) GetAllPai() []int8 {
...
/*
func (A *PokerPDKSeat) FindGreaterPai(playSeat *PokerPDKSeat, rule *PDKRule) bool {
