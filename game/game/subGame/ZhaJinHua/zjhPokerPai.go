...
type zhaJinHuaPaiMgr struct {
	...
	seatReserve   [8][]int8         // 测试牌
	reservePaiMap map[int8]struct{} // 测试牌
}

func NewPokerPaiBaseMgr(test bool) *zhaJinHuaPaiMgr {
	return &zhaJinHuaPaiMgr{
...
// 洗牌
func (this *zhaJinHuaPaiMgr) XiPai(players, groupPaiCount int32) {
...
// 发牌
func (this *zhaJinHuaPaiMgr) GetGroupPai(seatNum, takeout int32) []int8 {
...
// 剩余牌的数量
func (this *zhaJinHuaPaiMgr) GetTheRestOfPaiCount() int32 {
	return int32(len(this.notUsePaiMap))
}

// 获取剩下所有的牌
func (this *zhaJinHuaPaiMgr) GetSurplusPai() []int8 {
	return this.surplusPaiArr
}

// 预定
func (this *zhaJinHuaPaiMgr) Reserve(seatNum int32, paiArr []int8) (int8, int32) {
...
func (this *zhaJinHuaPaiMgr) ReadTestPai() {
...
func PaiStringToValue(pai string) int8 {
	pokerPaiStringToValueMap := map[string]int8{
		...
		"MH3": 0x13, "MH4": 0x14, "MH5": 0x15, "MH6": 0x16, "MH7": 0x17, "MH8": 0x18, "MH9": 0x19, "MH10": 0x1A, "MHJ": 0x1B, "MHQ": 0x1C, "MHK": 0x1D, "MHA": 0x1E, "MH2": 0x1F,
